...
class AttendancePdfGenerator
  ...
  def add_header(pdf)
    ...
    # Title
    pdf.text_box 'CPU Business and Information Technology College Portal Attendance Sheet',
                 at: [0, pdf.bounds.top - 30], width: pdf.bounds.width, align: :center, size: 30
  end
