class StudentTemporary < Prawn::Document
  def initialize(students, degree, gc_date)
    ...
    @students.each_with_index do |stud, index|
      ...
      move_down 20
      text "Graduated from CPU Business and Information Technology College", inline_format: true, size: 18, align: :center
      move_down 20
  ...
  def header_footer
    repeat :all do
      bounding_box [bounds.left, bounds.top], :width => bounds.width do
        font "Helvetica"
        image open("app/assets/images/cpu_logo.png"), fit: [120, 100], position: :center
        stroke_horizontal_rule
      end
