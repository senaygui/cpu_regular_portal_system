class StudentTemporary < Prawn::Document
  def initialize(students, degree, _gc_date)
    ...
    @students.each_with_index do |stud, _index|
      ...
      move_down 10
      text 'CPU Business and Information Technology College', inline_format: true, size: 20, align: :center
      move_down 10
      text 'OFFICE OF THE REGISTRAR', inline_format: true, size: 18, align: :center
      move_down 10
      text '<u>TEMPORARY CERTIFICATE OF GRADUATION</u>', inline_format: true, size: 22, font_style: :bold,
                                                         align: :center
      move_down 30
      ...
      move_down 20
      text 'Graduated from CPU Business and Information Technology College', inline_format: true, size: 18,
                                                                             align: :center
      move_down 20
      text 'with', inline_format: true, size: 18, align: :center
      move_down 20
      text "<u>Degree of #{degree} in #{stud.department.department_name}</u>", inline_format: true, size: 22,
                                                                               font_style: :bold, align: :center
      move_down 20
      text "<u>On #{Date.parse('2025-04-09').strftime('%d %B,%Y')}</u>", inline_format: true, size: 22,
                                                                         font_style: :bold, align: :center
      move_down 20
      text 'This certificate of graduation has been given pending the printing and issuance of actual diploma.',
           inline_format: true, size: 18, align: :center
      move_down 60
  ...
  def header_footer
    repeat :all do
      ...
      #     stroke_horizontal_rule
      #     move_down(5)
      #     text "CPU Business and Information Technology College Registrar Portal", :size => 16, align: :center
